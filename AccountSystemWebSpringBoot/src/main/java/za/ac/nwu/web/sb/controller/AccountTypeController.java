...
import za.ac.nwu.web.domain.service.GeneralResponse;
...
public class AccountTypeController {
    ...
    @GetMapping("/all")
    @ApiOperation(value = "Gets all of the configured account types.", notes = "Returns a list of account types")
    @ApiResponses(value = {
    ...
    @PostMapping("")
    @ApiOperation(value = "Creates a new account AccountType.", notes = "Creates a new AccountType in the DB.")
    @ApiResponses( value = {
    ...
    public ResponseEntity<GeneralResponse<AccountTypeDto>> getAccouuntType(
            @ApiParam(value = "The memberID that uniquely identifies the AccountType.", name = "member_ID", required = true)
